...
use crate::{mem::fast::Ram512, Demux8Way, Mux8Way16, Signal, Signal12, Signal16, Time, Unit};
...
impl Unit for Ram4k {
    fn tick(&mut self) {
        self.time += 1;
        let mux_signal = self.address.get(9..12).into();
